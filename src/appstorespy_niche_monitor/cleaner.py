...
from .coverage import extract_response_apps
...
def iter_response_apps(response: Any) -> Iterable[dict[str, Any]]:
    yield from extract_response_apps(response)
...
def normalize_app(raw: dict[str, Any], meta: dict[str, Any], snapshot_date: str) -> dict[str, Any]:
    ...
    language = str(first_present(raw, ["language", "lang", "locale"], ""))
    ...
    return {
        ...
        "raw_source_fields_json": dict(raw),
    }
